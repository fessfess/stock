...
<?php if ( ((MS_PAGINATION_POSITION==1) || (MS_PAGINATION_POSITION==3)) && ($a_customers->Export == "")) { ?>
...
foreach ($sRecPerPageList as $a) {
 $thisDisplayRecs = $a;
?>
    <option <?php if ($thisDisplayRecs > 0)  { ?> value="<?php echo $thisDisplayRecs; ?>"<?php }else{ ?> value="ALL"<?php } ?> <?php if (($thisDisplayRecs > 0 && $a_customers_list->DisplayRecs == $thisValue) || $a_customers->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?> > <?php if ($thisDisplayRecs > 0) {echo $thisDisplayRecs;} else {echo $Language->Phrase("AllRecords"); }?> </option>
<?php } ?>
</select>
</div>
<?php } ?>
		<?php if (MS_PAGINATION_STYLE==1 && !isset($a_customers_list->Pager)) $a_customers_list->Pager = new cNumericPager($a_customers_list->StartRec, $a_customers_list->DisplayRecs, $a_customers_list->TotalRecs, $a_customers_list->RecRange) ?>
				...
				<div class="ewNumericPage"><ul class="pagination">
					<li><a href="<?php echo $a_customers_list->PageUrl() ?>start=<?php echo $a_customers_list->Pager->FirstButton->Start ?>"><?php if($a_customers_list->Pager->FirstButton->Enabled && $Language->Phrase("dir") == "rtl") {echo $Language->Phrase("PagerLast");} if($a_customers_list->Pager->FirstButton->Enabled && $Language->Phrase("dir") != "rtl"){echo $Language->Phrase("PagerFirst");} ?></a></li>

					<li><a href="<?php echo $a_customers_list->PageUrl() ?>start=<?php echo $a_customers_list->Pager->PrevButton->Start ?>"><?php if($a_customers_list->Pager->PrevButton->Enabled && $Language->Phrase("dir") == "rtl"){echo $Language->Phrase("PagerNext");} if($a_customers_list->Pager->PrevButton->Enabled && $Language->Phrase("dir") != "rtl"){echo $Language->Phrase("PagerPrevious");} ?></a></li>
					...
					<li><a href="<?php echo $a_customers_list->PageUrl() ?>start=<?php echo $a_customers_list->Pager->NextButton->Start ?>"><?php if($a_customers_list->Pager->NextButton->Enabled && $Language->Phrase("dir") == "rtl"){echo $Language->Phrase("PagerPrevious");} if($a_customers_list->Pager->NextButton->Enabled && $Language->Phrase("dir") != "rtl"){echo $Language->Phrase("PagerNext");} ?></a></li>

					<li><a href="<?php echo $a_customers_list->PageUrl() ?>start=<?php echo $a_customers_list->Pager->LastButton->Start ?>"><?php if($a_customers_list->Pager->LastButton->Enabled && $Language->Phrase("dir") == "rtl"){echo $Language->Phrase("PagerFirst");} if($a_customers_list->Pager->LastButton->Enabled && $Language->Phrase("dir") == "rtl"){echo $Language->Phrase("PagerLast");} ?></a></li>
